...
def mock_web3():
    ...
    mock_w3.eth.get_balance.return_value = 1000 * 10**18  # 1000 ETH
    mock_w3.eth.gas_price = 20 * 10**9  # 20 Gwei
...
@pytest.fixture
def sample_flashloan_params():
    """Sample flash loan parameters for testing."""
    return {
        'token': '0xA0b86a33E6411f9a5Ef0dE370c0b3b1f1E7b8E9C',  # Mock USDC
        'amount': 100000 * 10**6,  # 100k USDC (6 decimals)
        'recipient': '0x742dA73Fe8e4B0b42d9D1B6C3F4d1F7b7b5c5c5c',
        'data': '0x',
        'premium': 9,  # 0.09%
        'gas_limit': 500000,
