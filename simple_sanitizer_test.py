...
def test_sanitizer():
    ...
    try:
        result = emergency_validate_eth_address("0x742dA73Fe8e4B0b42d9D1B6C3F4d1F7b7b5c5c5c")
        print(f"✅ Valid address: {result}")
    except Exception as e:
        print(f"❌ Valid address rejected: {e}")
    
    try:
        result = emergency_validate_eth_address("0x0000000000000000000000000000000000000000")
