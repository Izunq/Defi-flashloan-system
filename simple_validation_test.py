...
def test_validation():
    ...
    addr_tests = [
        ("0x742dA73Fe8e4B0b42d9D1B6C3F4d1F7b7b5c5c5c", True),
        ("0x0000000000000000000000000000000000000000", False),
        ("0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF", False),
        ("0x0000000000000000000000000000000000000001", False),
        ("0x000000000000000000000000000000000000dEaD", False),
        ("invalid_address", False),
        ("0x742dA73Fe8e4B0b42d9D1B6C3F4d1F7b7b5c5c", False),
        ("0x742dA73Fe8e4B0b42d9D1B6C3F4d1F7b7b5c5c5c5c", False),
    ]
