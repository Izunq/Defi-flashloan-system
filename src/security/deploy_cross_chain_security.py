...
class CrossChainSecurityDeployer:
    ...
    def _setup_emergency_controls(self) -> Dict[str, Any]:
        ...
        emergency_config = {
            'pause_authorities': [
                '${CONTRACT_ADDRESS}',  # Emergency admin
                '${CONTRACT_ADDRESS}',  # Security team
                '${CONTRACT_ADDRESS}'   # Operations team
            ],
            'pause_durations': {
...
DEPLOYMENT_CONFIG = {
    ...
    "contracts": {
        "1": {"mesh": "${CONTRACT_ADDRESS}"},
        "137": {"mesh": "${CONTRACT_ADDRESS}"},
        "42161": {"mesh": "${CONTRACT_ADDRESS}"}
    },
    "oracles": [
